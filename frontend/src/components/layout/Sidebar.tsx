  ...
  return (
    <aside className="w-64 h-screen bg-neutral-100 border-r-2 border-neutral-950 p-6 flex flex-col gap-8 font-sans">
      <div className="flex items-center gap-3 px-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-neutral-950 tracking-tighter">
            Rago
          </h1>
      ...
      <nav className="flex flex-col gap-3 flex-1">
        {links.map((link) => (
          <Link
            ...
            activeProps={{
              className:
                "bg-primary-400 text-black border-neutral-950 shadow-hard-md",
            }}
          >
            <link.icon size={32} />
      ...
      <div className="px-4 py-4 bg-white border-2 border-neutral-950 rounded shadow-hard-sm mb-8">
        ...
        {isUnlimited ? (
          <div className="flex items-baseline justify-between">
            ...
            <span className="px-2 py-0.5 bg-primary-400 border border-neutral-950 rounded text-[10px] font-bold uppercase shadow-hard-sm">
              Ilimitado
            </span>
          </div>
        ) : (
